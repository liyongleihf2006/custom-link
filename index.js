...
var _history3 = __webpack_require__(/*! history */ "./node_modules/history/es/index.js");
 ...
 */
var CustomLink = (_temp2 = _class = function (_React$Component) {
  ...
  function CustomLink() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = CustomLink.__proto__ || (0, _getPrototypeOf2.default)(CustomLink)).call.apply(_ref, [this].concat(args))), _this), _this.handleClick = function (event) {
      ...
      !isModifiedEvent(event) // ignore clicks with modifier keys
          ...
          var _history = _this.context.router.history;
  ...
  (0, _createClass3.default)(CustomLink, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          props = (0, _objectWithoutProperties3.default)(_props, ["render", "replace", "to", "innerRef"]); // eslint-disable-line no-unused-vars

      (0, _invariant2.default)(this.context.router, "You should not use <CustomLink> outside a <Router>");
      if (!render) {
        (0, _invariant2.default)(to !== undefined, 'When you\'re not specity the "render" property,you must specify the "to" property');
        var _history2 = this.context.router.history;

        var location = typeof to === "string" ? (0, _history3.createLocation)(to, null, null, _history2.location) : to;

        var href = _history2.createHref(location);
        return _react2.default.createElement("a", (0, _extends3.default)({}, props, { onClick: this.handleClick, ref: innerRef }));
      }
...
function isPathEqual(path1, path2) {
  ...
  function getHref(to) {
    var location = typeof to === "string" ? (0, _history3.createLocation)(to, null, null, history.location) : to;
    return (0, _history3.createPath)(location);
  }
}
